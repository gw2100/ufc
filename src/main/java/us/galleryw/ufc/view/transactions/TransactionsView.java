package us.galleryw.ufc.view.transactions;
...
public final class TransactionsView extends VerticalLayout implements View {
    ...
    private Table buildTable() {
        ...
        table.setContainerDataSource(new TempTransactionsContainer(UfcUI
        ...
        table.setColumnFooter(
                "price",
                "$"
                        + DECIMALFORMAT.format(UfcUI.getDataProvider()
                                .getTotalSum()));
    ...
    void createNewReportFromSelection() {
        UI.getCurrent().getNavigator()
                .navigateTo(UfcViewType.REPORTS.getViewName());
        UfcEventBus.post(new TransactionReportEvent(
            ...
            if (action == report) {
                ...
                if (item != null) {
                    Long movieId = (Long) item.getItemProperty("movieId")
                            .getValue();
                    MovieDetailsWindow.open(UfcUI.getDataProvider()
