...
import us.galleryw.ufc.component.MovieDetailsWindow;
...
public final class UsersView extends VerticalLayout implements View {
            ...
            public void textChange(final TextChangeEvent event) {
                ...
                data.addContainerFilter(new Filter() {
                    ...
                    public boolean passesFilter(final Object itemId, final Item item) {
                        ...
                        return filterByProperty("country", item, event.getText()) || filterByProperty("city", item, event.getText())
    ...
    private Table buildTable() {
        ...
        table.setContainerDataSource(new TempTransactionsContainer(UfcUI.getDataProvider().getRecentTransactions(200)));
        ...
        table.setColumnFooter("price", "$" + DECIMALFORMAT.format(UfcUI.getDataProvider().getTotalSum()));
        ...
        public void handleAction(final Action action, final Object sender, final Object target) {
            if (action == report) {
                ...
                if (item != null) {
                    ...
                    MovieDetailsWindow.open(UfcUI.getDataProvider().getMovie(movieId), null, null);
                }
            }
        }
    ...
    private class TempTransactionsContainer extends FilterableListContainer<Transaction> {
        ...
        public TempTransactionsContainer(final Collection<Transaction> collection) {
            super(collection);
        }
