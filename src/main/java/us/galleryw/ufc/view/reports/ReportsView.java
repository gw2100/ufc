...
import us.galleryw.ufc.view.reports.ReportEditor.PaletteItemType;
import us.galleryw.ufc.view.reports.ReportEditor.ReportEditorListener;
...
public final class ReportsView extends TabSheet implements View, CloseHandler,
    ...
    public void addReport(final ReportType reportType, final Object prefillData) {
        ...
        UfcEventBus.post(new ReportsCountUpdatedEvent(
                getComponentCount() - 1));
