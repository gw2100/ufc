package us.galleryw.ufc.view.dashboard;

import java.util.Collection;
import java.util.Iterator;

import us.galleryw.ufc.UfcUI;
import us.galleryw.ufc.component.SparklineChart;
import us.galleryw.ufc.component.TopGrossingMoviesChart;
import us.galleryw.ufc.component.TopSixTheatersChart;
import us.galleryw.ufc.component.TopTenMoviesTable;
import us.galleryw.ufc.data.dummy.DummyDataGenerator;
import us.galleryw.ufc.domain.DashboardNotification;
import us.galleryw.ufc.event.UfcEvent.NotificationsCountUpdatedEvent;
import us.galleryw.ufc.event.UfcEventBus;
import us.galleryw.ufc.view.dashboard.DashboardEdit.DashboardEditListener;
...
public final class DashboardView extends Panel implements View,
    ...
    private void openNotificationsPopup(final ClickEvent event) {
        ...
        Collection<DashboardNotification> notifications = UfcUI
                .getDataProvider().getNotifications();
        UfcEventBus.post(new NotificationsCountUpdatedEvent());
    ...
    public static final class NotificationsButton extends Button {
        ...
        public void updateNotificationsCount(
            ...
            setUnreadCount(UfcUI.getDataProvider()
