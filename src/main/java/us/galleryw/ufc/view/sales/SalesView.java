package us.galleryw.ufc.view.sales;
...
import us.galleryw.ufc.domain.MovieRevenue;
...
public class SalesView extends VerticalLayout implements View {
    ...
    public SalesView() {
        ...
        List<Movie> subList = new ArrayList<Movie>(UfcUI
    ...
    private void initMovieSelect() {
        Collection<Movie> movies = UfcUI.getDataProvider().getMovies();
    ...
    private void addDataSet(final Movie movie) {
        ...
        Collection<MovieRevenue> dailyRevenue = UfcUI.getDataProvider()
