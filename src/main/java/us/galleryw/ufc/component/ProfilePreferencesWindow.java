package us.galleryw.ufc.component;
...
public class ProfilePreferencesWindow extends Window {
    private Logger LOG = LoggerFactory.getLogger(ProfilePreferencesWindow.class);
...
//    private OptionalSelect<Integer> newsletterField;
    ...
    private Component buildProfileTab() {
        ...
        genderField.addItem("U");
        genderField.addItem("M");
        genderField.addItem("F");
...
//        details.addComponent(section);
    ...
    private Component buildFooter() {
        ...
        ok.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                try {
                    ...
                    UfcEventBus.post(new ProfileUpdatedEvent(fieldGroup.getItemDataSource().getBean()));
                    close();
        ...
        footer.addComponent(new Button("Cancel",e->close()));
        return footer;
    }
